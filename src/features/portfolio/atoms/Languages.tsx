...
import { faCss3Alt, faHtml5, faNodeJs, faWindows } from '@fortawesome/free-brands-svg-icons';
...
const Languages = () => {
    return (
        <Card>
            ...
            <HiddenList>
                <LanguageItem><FontAwesomeIcon icon={faWindows} color="darkslateblue" />C#</LanguageItem>
                <LanguageItem><FontAwesomeIcon icon={faNodeJs} color="cornflowerblue" />TypeScript</LanguageItem>
